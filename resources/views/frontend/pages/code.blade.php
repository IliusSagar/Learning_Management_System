    ...
    <div class="row">
        ...
        <div class="col-md-6 position-relative">
           <h1 class="position-absolute top-50 start-50 translate-middle">Laravel CRUD</h1>
                ...
                <center>
                    <a href="{{ url('/') }}" class="btn btn btn-primary"><</a>
        ...
        <div class="col-md-12">
            <center><a href="{{ url('/code/more')}}" class="btn btn-warning" style="font-size: 22px;">Code More...<span style="font-size: 18px;">$</span>10</a></center>
        </div>
